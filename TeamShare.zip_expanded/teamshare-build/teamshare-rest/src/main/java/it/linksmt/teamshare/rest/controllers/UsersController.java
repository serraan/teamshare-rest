...
public class UsersController {
	...
	@ApiOperation(value = "Get Utenti", notes = "Servizio rest per visualizzare la lista degli utenti", response = UserDto.class)
	...
	@ApiOperation(value = "Get Utente", notes = "Servizio rest per visualizzare il dettaglio dell'utente", response = UserDto.class)
	@ApiResponse(code = 200, message = "Dettaglio utente", response = UserDto.class)
	@RequestMapping(value="/{idUtente}", method = RequestMethod.GET)
	public ResponseEntity<UserDto> getUser (
			@PathVariable(name = "idUtente") @ApiParam(value = "ID utente", required = true) final int userId)
	{
	...
	@ApiOperation(value = "Insert Utente", notes = "Servizio rest per aggiungere un utente", response = UserDto.class)
	...
	@RequestMapping(value="/{idUtente}", method = RequestMethod.PUT)
	...
	@ApiOperation(value = "Delete Utente", notes = "Servizio rest per eliminare un utente", response = UserDto.class)
	@ApiResponse(code = 200, message = "Eliminazione utente", response = UserDto.class)
	@RequestMapping(value="/{idUtente}", method = RequestMethod.DELETE)
