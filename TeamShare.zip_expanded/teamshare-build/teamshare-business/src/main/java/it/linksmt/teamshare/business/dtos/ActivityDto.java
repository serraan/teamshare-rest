...
public class ActivityDto extends ActivityRequestDto implements Serializable {
	...
	public String toString() {
		return "ActivityDto [id=" + id + ", getTitle()=" + getTitle() + ", getDescription()=" + getDescription()
				+ ", getType()=" + getType() + ", getPriority()=" + getPriority() + ", getDateTakenCharge()="
				+ getDateTakenCharge() + ", getIdUserCreator()=" + getIdUserCreator() + ", getIdUserAssignee()="
				+ getIdUserAssignee() + "]";
	}
