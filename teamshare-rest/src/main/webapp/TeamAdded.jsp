...
<%@page import="it.linksmt.teamshare.business.dto.request.TeamRequestDto"%>
...
<title>One team Added</title>
</head>
<body>
	<%
		TeamRequestDto team = (TeamRequestDto) request.getAttribute("teamAdded");
		DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
		String date;
// 		out.println(act.toString());
		%>
		<div class="container">
			<h3>The team <%out.write(team.getName()); %> was added with Success</h3>
		</div>
</body>
