...
public class ActivitiesController {
	...
	@ResponseBody
	public ResponseEntity<ActivityDto> updateAct(@PathVariable("attId") int attId,@RequestBody ActivityRequestDto activity) {
	...
	@ResponseBody
	public void removeAct(@PathVariable Integer activityId) {
